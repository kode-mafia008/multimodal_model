...
class MultiModalTrainer:
    def __init__(self,model,train_loader,val_loader):
        ...
        timestamp = datetime.now().strftime("%Y%m%d-%H%M%S") # Dec17_14-22-35
    ...
    def evaluate(self,data_loader,phase='val'):
        ...
        with torch.inference_mode():
            ...
            self.log_metrics(avg_loss,metrics,phase)
...
if __name__ == "__main__":
    dataset = MELDDataset(csv_path='../dataset/train/train_sent_emo.csv',video_dir='../dataset/train/train_splits')
