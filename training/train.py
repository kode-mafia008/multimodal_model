...
from meld_dataset import prepare_data_loaders
...
def parse_args():
    ...
    parser.add_argument('--validation-dir',type=str,default=SM_CHANNEL_VALIDATION)
...
def main():
    if not install_ffmpeg():
        raise RuntimeError("FFmpeg installation failed - required for training")
        sys.exit(1)
    ...
    metrics_data['test_logg'] = test_loss["total"]
